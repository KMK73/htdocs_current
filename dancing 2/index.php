...
<html>
	...
	<body>
		<form>
			...
			<div id="dancer_profile_britney" class="profile" style="display:none;">
				You like to dance. A lot.
			</div>
			<div id="dancer_profile_sly" class="profile" style="display:none;">
				You love dancing. You're awesome. Eat some food.
			</div>
